  ...
  createButton: function (e) {
    function t(t) {
      ((s.style.display = ''),
        ...
        (s.style.left = 'calc(50% - 50px)'),
        (s.style.width = '100px'),
        (s.textContent = 'ENTER VR'),
        ...
        (s.onclick = function () {
          t.isPresenting ? t.exitPresent() : t.requestPresent([{ source: e.domElement }]);
        }),
        e.vr.setDevice(t));
    }
    function n() {
      ((s.style.display = ''),
        (s.style.cursor = 'auto'),
        (s.style.left = 'calc(50% - 75px)'),
        (s.style.width = '150px'),
        (s.textContent = 'VR NOT FOUND'),
        (s.onmouseenter = null),
        (s.onmouseleave = null),
        (s.onclick = null),
        e.vr.setDevice(null));
    ...
    if ('getVRDisplays' in navigator) {
      ...
      return (
        ...
        window.addEventListener(
          ...
          function (e) {
            s.textContent = e.display.isPresenting ? 'EXIT VR' : 'ENTER VR';
          },
          !1
        ),
    ...
    return (
      (i.href = 'https://webvr.info'),
      (i.innerHTML = 'WEBVR NOT SUPPORTED'),
      (i.style.left = 'calc(50% - 90px)'),
      (i.style.width = '180px'),
