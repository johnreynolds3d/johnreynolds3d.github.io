  ...
  Prism = (function () {
    var e = /\blang(?:uage)?-(\w+)\b/i,
      ...
      a = (_self.Prism = {
        ...
        util: {
          ...
          clone: function (e) {
            switch (a.util.type(e)) {
              case 'Object':
                var t = {};
                for (const n in e) e.hasOwnProperty(n) && (t[n] = a.util.clone(e[n]));
                return t;
              case 'Array':
        ...
        highlightAllUnder: function (e, t, n) {
          ...
          for (var i, s = r.elements || e.querySelectorAll(r.selector), l = 0; (i = s[l++]); )
            a.highlightElement(i, !0 === t, r.callback);
        },
        highlightElement: function (t, n, r) {
          for (var i, s, l = t; l && !e.test(l.className); ) l = l.parentNode;
          (l && ((i = (l.className.match(e) || [, ''])[1].toLowerCase()), (s = a.languages[i])),
          ...
          const o = { element: t, language: i, grammar: s, code: t.textContent };
          if ((a.hooks.run('before-sanity-check', o), !o.code || !o.grammar))
            return (
              o.code &&
                (a.hooks.run('before-highlight', o),
                (o.element.textContent = o.code),
                a.hooks.run('after-highlight', o)),
              void a.hooks.run('complete', o)
            );
          if ((a.hooks.run('before-highlight', o), n && _self.Worker)) {
            ...
            ((o.highlightedCode = a.highlight(o.code, o.grammar, o.language)),
              a.hooks.run('before-insert', o),
              (o.element.innerHTML = o.highlightedCode),
              r && r.call(t),
              a.hooks.run('after-highlight', o),
            ...
            if (n.hasOwnProperty(u) && n[u]) {
              ...
              for (let c = 0; c < g.length; ++c) {
                ...
                if (h && !p.pattern.global) {
                  const b = p.pattern.toString().match(/[imuy]*$/)[0];
                  p.pattern = RegExp(p.pattern.source, b + 'g');
                }
                p = p.pattern || p;
                for (let v = r, k = i; v < t.length; k += t[v].length, ++v) {
                  let P = t[v];
                  ...
                  if (!(P instanceof o)) {
                    ...
                    let w = p.exec(P),
                      x = 1;
                    if (!w && h && v != t.length - 1) {
                      if (((p.lastIndex = k), !(w = p.exec(e)))) break;
                      for (
                        var F = w.index + (m ? w[1].length : 0), S = w.index + w[0].length, A = v, _ = k, j = t.length;
                        A < j && (_ < S || (!t[A].type && !t[A - 1].greedy));
                        ++A
                      )
                        F >= (_ += t[A].length) && (++v, (k = _));
                      if (t[v] instanceof o || t[A - 1].greedy) continue;
                      ((x = A - v), (P = e.slice(k, _)), (w.index -= k));
                    }
                    if (w) {
                      m && (f = w[1].length);
                      var S = (F = w.index + f) + (w = w[0].slice(f)).length,
                        C = P.slice(0, F),
                        N = P.slice(S),
                        O = [v, x];
                      C && (++v, (k += C.length), O.push(C));
                      const E = new o(u, d ? a.tokenize(w, d) : w, y, w, h);
                      if (
                        (O.push(E),
                        N && O.push(N),
    ...
    if (
      ((n.stringify = function (e, t, r) {
        ...
        if (e.alias) {
          const s = 'Array' === a.util.type(e.alias) ? e.alias : [e.alias];
          Array.prototype.push.apply(i.classes, s);
        }
        a.hooks.run('wrap', i);
        const l = Object.keys(i.attributes)
          .map(function (e) {
      ...
      return _self.addEventListener
        ? (a.disableWorkerMessageHandler ||
          ...
          _self.Prism)
        : _self.Prism;
    const r = document.currentScript || [].slice.call(document.getElementsByTagName('script')).pop();
    return (
      r &&
        ((a.filename = r.src),
        a.manual ||
  ...
  'undefined' != typeof self &&
    ...
    ((self.Prism.fileHighlight = function () {
      ...
      Array.prototype.slice.call(document.querySelectorAll('pre[data-src]')).forEach(function (t) {
        for (
          var a, n = t.getAttribute('data-src'), r = t, i = /\blang(?:uage)?-(?!\*)(\w+)\b/i;
          ...
          (o.onreadystatechange = function () {
            4 == o.readyState &&
              (o.status < 400 && o.responseText
                ? ((l.textContent = o.responseText), Prism.highlightElement(l))
                : o.status >= 400
                  ? (l.textContent = '✖ Error ' + o.status + ' while fetching file: ' + o.statusText)
